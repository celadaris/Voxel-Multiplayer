...
public class MoveNetPlayers : MonoBehaviour
{
    ...
    {
        if (player1.activeSelf && jitterBufferScript.player1Update)
        {
        ...
        if (player2.activeSelf && jitterBufferScript.player2Update)
        {
        ...
        if (player3.activeSelf && jitterBufferScript.player3Update)
        {
        ...
        if (player4.activeSelf && jitterBufferScript.player4Update)
        {
    ...
    {
        if (player1.activeSelf && player1IsInterpolating)
        {
        ...
        if (player2.activeSelf && player2IsInterpolating)
        {
        ...
        if (player3.activeSelf && player3IsInterpolating)
        {
        ...
        if (player4.activeSelf && player4IsInterpolating)
        {
